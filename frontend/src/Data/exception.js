export const exception = [
    ...
    { exception_no: 4, exception_layer:"accountinglayer",exception_type:"high",exception_name:"requiredFieldEmpty",exception_name:"rulesOtherwise",exception_desc:"Rule engine exception" },  
  ];